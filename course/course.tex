...
\usepackage{rotating}
\usepackage{pifont}
%\usepackage{microtype}%tracking=alltext,letterspace=1000
\usepackage[a4paper,left=2cm,right=2cm,top=2cm,bottom=2cm,headheight=14pt,headsep=8pt]{geometry}


\setCJKmainfont[AutoFakeBold=2]{SimSun}%BoldFont=SimHei,ItalicFont=KaiTi(\bf,\it)
\setCJKsansfont{SimHei}
\setCJKmonofont{FangSong}
\setmainfont{Times New Roman}
\setsansfont{Arial}%无衬线字体\sf   Arial、Calibri、Latin Modern Sans
%\setmonofont{Courier}%等宽字体/打印机字体\tt
%\setmathfont{Latin Modern Math}
%\setsansfont[AutoFakeBold=1.5]{Latin Modern Sans}
\linespread{1.25}
...
%\renewcommand{\CJKglue}{\hskip 2em}
...
\begin{document}
    ...
    \begin{titlepage}
		\centering
		\vspace*{1.75cm}
		%\quad\includegraphics[width=6cm,height=2cm]{figures/test.png}\\
        {\fontsize{50pt}\baselineskip\stxingkai 某某大学}\\
		\vspace*{2cm}
		{\fontsize{40pt}\baselineskip\bf\ziju{0.3} 课程设计报告}
		 \vskip 5cm
        {\heiti
		 \fontsize{16pt}\baselineskip
         \makebox[24mm]{课程名称}
		 \underline{\makebox[117mm][c]{\sf\@coursename}}\\
         \vskip 0.9cm
		 \makebox[24mm]{设计题目}
		 \underline{\makebox[117mm][c]{\sf\art@title}}\\
		 \vskip 0.9cm
         \makebox[24mm]{班\qquad\;\;级}
		 \underline{\makebox[117mm][c]{\sf }}\\
		 \vskip 0.9cm
		 \makebox[24mm]{姓\qquad\;\;名}
		 \underline{\makebox[43mm][c]{\sf }}
         \hskip 0.4cm
		 \makebox[24mm]{学\qquad\;\;号}
		 \underline{\makebox[43mm][c]{\sf }}\\
		 \vskip 0.9cm
		 \makebox[24mm]{指导教师}
		 \underline{\makebox[43mm][c]{}}
         \hskip 0.4cm
         \makebox[24mm]{评\qquad\;\;分}
		 \underline{\makebox[43mm][c]{ }}\\
		 \vskip 4.3cm
		 \fontsize{18pt}\baselineskip~~{\sf{\number\year}}~~年~~{\sf{\number\month}}~~月}		
	\end{titlepage}
